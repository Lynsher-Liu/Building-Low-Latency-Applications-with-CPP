...
## mission
Run latency arbitrage workflows for tail-latency compression and deterministic path behavior with reproducible diagnostics and controlled release criteria.
