# diagnostics for latency arbitrage.
...
required_columns = ('timestamp', 'stage_name', 'latency_us', 'jitter_us', 'throughput_messages', 'drop_rate', 'cpu_utilization', 'memory_utilization', 'p99_latency_us', 'spread_value', 'hedge_ratio', 'zscore')
numeric_columns = ('latency_us', 'jitter_us', 'throughput_messages', 'drop_rate', 'cpu_utilization', 'memory_utilization', 'packet_loss_rate', 'p99_latency_us', 'spread_value', 'hedge_ratio', 'zscore')
...
def parse_arguments():
    parser = argparse.ArgumentParser(description="diagnostics for latency arbitrage")
