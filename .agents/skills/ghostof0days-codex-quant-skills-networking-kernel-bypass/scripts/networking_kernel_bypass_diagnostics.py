# diagnostics for networking kernel bypass.
...
required_columns = ('timestamp', 'stage_name', 'latency_us', 'jitter_us', 'throughput_messages', 'drop_rate', 'cpu_utilization', 'memory_utilization', 'packet_rate', 'packet_loss_rate', 'retransmit_count')
numeric_columns = ('latency_us', 'jitter_us', 'throughput_messages', 'drop_rate', 'cpu_utilization', 'memory_utilization', 'packet_loss_rate', 'p99_latency_us', 'packet_rate', 'retransmit_count')
...
def parse_arguments():
    parser = argparse.ArgumentParser(description="diagnostics for networking kernel bypass")
