# diagnostics for latency optimization.
...
required_columns = ('timestamp', 'stage_name', 'latency_us', 'jitter_us', 'throughput_messages', 'drop_rate', 'cpu_utilization', 'memory_utilization', 'p99_latency_us', 'solver_iterations', 'duality_gap')
numeric_columns = ('latency_us', 'jitter_us', 'throughput_messages', 'drop_rate', 'cpu_utilization', 'memory_utilization', 'packet_loss_rate', 'p99_latency_us', 'solver_iterations', 'duality_gap')
...
def parse_arguments():
    parser = argparse.ArgumentParser(description="diagnostics for latency optimization")
