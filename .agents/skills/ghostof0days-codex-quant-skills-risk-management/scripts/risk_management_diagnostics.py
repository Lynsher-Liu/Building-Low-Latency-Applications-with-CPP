# diagnostics for risk management.
...
required_columns = ('timestamp', 'desk', 'gross_exposure', 'net_exposure', 'limit_value', 'breach_flag', 'incident_id')
numeric_columns = ('gross_exposure', 'net_exposure', 'limit_value', 'breach_flag', 'pnl', 'response_time_minutes')
...
def parse_arguments():
    parser = argparse.ArgumentParser(description="diagnostics for risk management")
