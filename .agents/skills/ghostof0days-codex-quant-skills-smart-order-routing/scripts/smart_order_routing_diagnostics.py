# diagnostics for smart order routing.
...
required_columns = ('timestamp', 'instrument', 'venue', 'side', 'order_size', 'fill_price', 'benchmark_price', 'latency_us', 'spread_bps', 'route_id', 'route_fill_rate')
numeric_columns = ('order_size', 'fill_price', 'benchmark_price', 'latency_us', 'spread_bps', 'slippage_bps', 'fill_rate', 'queue_ahead', 'route_id', 'route_fill_rate')
...
def parse_arguments():
    parser = argparse.ArgumentParser(description="diagnostics for smart order routing")
