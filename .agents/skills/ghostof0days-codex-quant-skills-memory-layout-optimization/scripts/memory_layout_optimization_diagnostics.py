# diagnostics for memory layout optimization.
...
required_columns = ('timestamp', 'stage_name', 'latency_us', 'jitter_us', 'throughput_messages', 'drop_rate', 'cpu_utilization', 'memory_utilization', 'solver_iterations', 'duality_gap')
...
def parse_arguments():
    parser = argparse.ArgumentParser(description="diagnostics for memory layout optimization")
