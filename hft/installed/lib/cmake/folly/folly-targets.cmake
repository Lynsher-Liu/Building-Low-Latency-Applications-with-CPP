...
set_target_properties(Folly::folly_deps PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "/home/ubuntu/xinyi_workspace/hft/hft_cpp20_system/Chapter10/installed/include;/usr/include;/usr/include/libiberty;/usr/include/x86_64-linux-gnu;${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "fmt::fmt;Threads::Threads;Boost::context;Boost::filesystem;Boost::program_options;Boost::regex;Boost::system;Boost::thread;/usr/lib/x86_64-linux-gnu/libdouble-conversion.so;gflags_shared;/usr/lib/x86_64-linux-gnu/libglog.so;/usr/lib/x86_64-linux-gnu/libevent.so;/usr/lib/x86_64-linux-gnu/libz.so;/usr/lib/x86_64-linux-gnu/libssl.so;/usr/lib/x86_64-linux-gnu/libcrypto.so;/usr/lib/x86_64-linux-gnu/liblzma.so;/usr/lib/x86_64-linux-gnu/liblz4.so;/usr/lib/x86_64-linux-gnu/libsnappy.so;/usr/lib/x86_64-linux-gnu/libiberty.a;/usr/lib/x86_64-linux-gnu/libsodium.so;dl;/usr/lib/x86_64-linux-gnu/libunwind.so"
)

# Create imported target Folly::folly_test_util
add_library(Folly::folly_test_util SHARED IMPORTED)
...
add_library(Folly::follybenchmark SHARED IMPORTED)
