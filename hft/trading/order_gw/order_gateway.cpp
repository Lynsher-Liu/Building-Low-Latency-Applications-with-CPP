 ...
 * @LastEditTime: 2026-03-24 17:33:38
 * @FilePath: /my_HFT/hft/trading/order_gw/order_gateway.cpp
  ...
  auto OrderGateway::run() noexcept -> void {
    ...
    while (run_) {
      ...
      for(auto client_request = outgoing_requests_->getNextToRead(); client_request; client_request = outgoing_requests_->getNextToRead()) {
        ...
        //             timer::getCurrentTimeStr(&time_str_), client_id_, next_outgoing_seq_num_, client_request->toString());
